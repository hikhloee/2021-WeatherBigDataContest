...
summary(diffset)
attributes(diffset)
write.csv(diffset,"C:/Users/kkh4y/Desktop/diffset.csv")



attach(data)
diff21<-diff(aws_avg_ps,1274)
...
summary(diffset)
attributes(diffset2)
write.csv(diffset2,"C:/Users/kkh4y/Desktop/diffset2.csv")